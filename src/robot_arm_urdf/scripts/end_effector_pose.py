...
class Ur5Moveit:
    ...
    def __init__(self):
        ...
        self._box_name = ""
        # Current State of the Robot is needed to add box to planningscene
...
def main():
    ...
    ur5_pose_1.position.x = -0.24339350809453478
    ur5_pose_1.position.y =  0.51767241565259
    ur5_pose_1.position.z = 0.468423706558423
    ur5_pose_1.orientation.x = 0.9635732283045276
    ur5_pose_1.orientation.y = 0.9635732283045276
    ur5_pose_1.orientation.z = 0.9635732283045276
    ur5_pose_1.orientation.w = 0.9635732283045276
